...
public class ListadoProcesosPopUp extends ListaPopUp implements ListadoProcesosInterface{
	...
	public ListadoProcesosPopUp() {
		...
		_cfCategorias = new ObjectChoiceField(null, null, 0, ObjectChoiceField.FORCE_SINGLE_LINE);
