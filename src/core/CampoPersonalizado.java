...
public class CampoPersonalizado {
	...
	public CampoPersonalizado(String id_campo, String nombre, String valor,
			Boolean obligatorio, int longitudMax, int longitudMin) {
	...
	public CampoPersonalizado(String id_campo, String id_atributo,
			String nombre, String valor, Boolean obligatorio, int longitudMax,
			int longitudMin) {
		this.id_campo = id_campo;
